...
| Conformance suites (`cauldron verify`) | Working. 682 cases, all from documentation so far |
...
Recipe: 682 cases, none yet run against a live account. Documentation-derived
