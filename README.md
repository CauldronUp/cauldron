...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 727 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10163 cases, 3660 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10163 cases, 3660 run against
a live account and 6503 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3660 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 517 of the 727, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 517 of the 727 here -- is served exactly as it
...
The table reaches 533 of the 727 Recipes. The other 194 ship and can be named
