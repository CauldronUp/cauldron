...
| Conformance suites (`cauldron verify`) | Working. 1226 cases, all from documentation so far |
...
Recipe: 1226 cases, none yet run against a live account. Documentation-derived
