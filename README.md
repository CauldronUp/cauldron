...
| Conformance suites (`cauldron verify`) | Working. 836 cases, all from documentation so far |
...
Recipe: 836 cases, none yet run against a live account. Documentation-derived
