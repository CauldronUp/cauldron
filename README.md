...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 162 of 183 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1919 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1919 cases, 58 run against
a live account and 1861 not. Documentation-derived cases are worth having,
...
The table reaches 162 of the 183 Recipes. The other 21 ship and can be named
