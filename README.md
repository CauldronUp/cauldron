...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 248 of 272 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2788 cases, 473 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2788 cases, 473 run against
...
The four hundred and seventy-three are the cases whose provider can be asked without a key. Six are
...
The table reaches 248 of the 272 Recipes. The other 24 ship and can be named
