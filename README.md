...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 834 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11213 cases, 4122 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11213 cases, 4122 run against
a live account and 7091 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4122 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 579 of the 834, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 579 of the 834 here -- is served exactly as it
...
The table reaches 533 of the 834 Recipes. The other 301 ship and can be named
