...
| Conformance suites (`cauldron verify`) | Working. 1165 cases, all from documentation so far |
...
Recipe: 1165 cases, none yet run against a live account. Documentation-derived
