...
| Conformance suites (`cauldron verify`) | Working. 1030 cases, all from documentation so far |
...
Recipe: 1030 cases, none yet run against a live account. Documentation-derived
