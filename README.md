...
| Conformance suites (`cauldron verify`) | Working. 691 cases, all from documentation so far |
...
Recipe: 691 cases, none yet run against a live account. Documentation-derived
