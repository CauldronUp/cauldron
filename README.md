...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 176 of 198 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2091 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2091 cases, 58 run against
a live account and 2033 not. Documentation-derived cases are worth having,
...
The table reaches 176 of the 198 Recipes. The other 22 ship and can be named
