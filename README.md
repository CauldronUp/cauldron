...
| Conformance suites (`cauldron verify`) | Working. 1418 cases, all from documentation so far |
...
Recipe: 1418 cases, none yet run against a live account. Documentation-derived
