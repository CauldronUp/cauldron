...
| Conformance suites (`cauldron verify`) | Working. 787 cases, all from documentation so far |
...
Recipe: 787 cases, none yet run against a live account. Documentation-derived
