...
| Conformance suites (`cauldron verify`) | Working. 1508 cases, all from documentation so far |
...
Recipe: 1508 cases, none yet run against a live account. Documentation-derived
