...
| Conformance suites (`cauldron verify`) | Working. 1490 cases, all from documentation so far |
...
Recipe: 1490 cases, none yet run against a live account. Documentation-derived
