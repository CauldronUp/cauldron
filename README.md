...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 210 of 234 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2442 cases, 127 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2442 cases, 127 run against
...
The hundred and twenty-seven are the cases whose provider can be asked without a key. Six are
...
The table reaches 210 of the 234 Recipes. The other 24 ship and can be named
