...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 230 of 254 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2628 cases, 313 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2628 cases, 313 run against
...
The three hundred and thirteen are the cases whose provider can be asked without a key. Six are
...
The table reaches 230 of the 254 Recipes. The other 24 ship and can be named
