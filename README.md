...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 190 of 212 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2241 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2241 cases, 58 run against
a live account and 2183 not. Documentation-derived cases are worth having,
...
The table reaches 190 of the 212 Recipes. The other 22 ship and can be named
