...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 487 of 631 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9154 cases, 3313 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9154 cases, 3313 run against
a live account and 5841 not. Documentation-derived cases are worth having,
...
**The number will not reach 631.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 631, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 631 here -- is served exactly as it
...
The table reaches 487 of the 631 Recipes. The other 144 ship and can be named
