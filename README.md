...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 499 of 644 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9297 cases, 3342 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6449 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9297 cases, 3342 run against
a live account and 5955 not. Documentation-derived cases are worth having,
...
**The number will not reach 644.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 644, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 644 here -- is served exactly as it
...
The table reaches 499 of the 644 Recipes. The other 145 ship and can be named
