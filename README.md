...
| Conformance suites (`cauldron verify`) | Working. 9079 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9079 cases, 3309 run against
a live account and 5770 not. Documentation-derived cases are worth having,
