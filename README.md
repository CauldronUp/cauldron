...
| Conformance suites (`cauldron verify`) | Working. 665 cases, all from documentation so far |
...
Recipe: 665 cases, none yet run against a live account. Documentation-derived
