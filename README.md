...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 745 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10363 cases, 3756 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10363 cases, 3756 run against
a live account and 6607 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3756 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 528 of the 745, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 528 of the 745 here -- is served exactly as it
...
The table reaches 533 of the 745 Recipes. The other 212 ship and can be named
