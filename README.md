...
| Conformance suites (`cauldron verify`) | Working. 7423 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 7423 cases, 3309 run against
a live account and 4114 not. Documentation-derived cases are worth having,
