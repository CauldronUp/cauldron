...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 254 of 278 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2834 cases, 519 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2834 cases, 519 run against
...
The five hundred and nineteen are the cases whose provider can be asked without a key. Six are
...
The table reaches 254 of the 278 Recipes. The other 24 ship and can be named
