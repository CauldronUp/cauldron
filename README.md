...
| Conformance suites (`cauldron verify`) | Working. 587 cases, all from documentation so far |
...
Recipe: 587 cases, none yet run against a live account. Documentation-derived
