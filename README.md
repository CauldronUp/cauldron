...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 153 of 173 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1813 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1813 cases, 58 run against
a live account and 1755 not. Documentation-derived cases are worth having,
...
The table reaches 153 of the 173 Recipes. The other 20 ship and can be named
