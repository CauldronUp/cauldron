...
| Conformance suites (`cauldron verify`) | Working. 536 cases, all from documentation so far |
...
Recipe: 536 cases, none yet run against a live account. Documentation-derived
