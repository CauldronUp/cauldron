...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 148 of 168 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1763 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1763 cases, 58 run against
a live account and 1705 not. Documentation-derived cases are worth having,
...
The table reaches 148 of the 168 Recipes. The other 20 ship and can be named
