...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 738 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10292 cases, 3725 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10292 cases, 3725 run against
a live account and 6567 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3725 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 523 of the 738, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 523 of the 738 here -- is served exactly as it
...
The table reaches 533 of the 738 Recipes. The other 205 ship and can be named
