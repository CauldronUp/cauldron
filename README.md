...
| Conformance suites (`cauldron verify`) | Working. 1339 cases, all from documentation so far |
...
Recipe: 1339 cases, none yet run against a live account. Documentation-derived
