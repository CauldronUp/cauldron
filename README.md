...
| Conformance suites (`cauldron verify`) | Working. 544 cases, all from documentation so far |
...
Recipe: 544 cases, none yet run against a live account. Documentation-derived
