...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 235 of 259 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2668 cases, 353 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2668 cases, 353 run against
...
The three hundred and fifty-three are the cases whose provider can be asked without a key. Six are
...
The table reaches 235 of the 259 Recipes. The other 24 ship and can be named
