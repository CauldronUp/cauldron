...
| Conformance suites (`cauldron verify`) | Working. 517 cases, all from documentation so far |
...
Recipe: 517 cases, none yet run against a live account. Documentation-derived
