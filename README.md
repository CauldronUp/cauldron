...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 512 of 657 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9435 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9435 cases, 3356 run against
a live account and 6079 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 512 of the 657, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 512 of the 657 here -- is served exactly as it
...
The table reaches 512 of the 657 Recipes. The other 145 ship and can be named
