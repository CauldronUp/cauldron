...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 151 of 171 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1794 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1794 cases, 58 run against
a live account and 1736 not. Documentation-derived cases are worth having,
...
The table reaches 151 of the 171 Recipes. The other 20 ship and can be named
