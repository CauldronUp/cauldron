...
| Conformance suites (`cauldron verify`) | Working. 1940 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1940 cases, 58 run against
a live account and 1882 not. Documentation-derived cases are worth having,
