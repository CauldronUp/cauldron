...
| Conformance suites (`cauldron verify`) | Working. 817 cases, all from documentation so far |
...
Recipe: 817 cases, none yet run against a live account. Documentation-derived
