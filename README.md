...
| Conformance suites (`cauldron verify`) | Working. 1353 cases, all from documentation so far |
...
Recipe: 1353 cases, none yet run against a live account. Documentation-derived
