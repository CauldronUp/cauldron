...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 183 of 205 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2170 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2170 cases, 58 run against
a live account and 2112 not. Documentation-derived cases are worth having,
...
The table reaches 183 of the 205 Recipes. The other 22 ship and can be named
