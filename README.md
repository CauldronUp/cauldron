...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 241 of 265 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2731 cases, 416 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2731 cases, 416 run against
...
The four hundred and sixteen are the cases whose provider can be asked without a key. Six are
...
The table reaches 241 of the 265 Recipes. The other 24 ship and can be named
