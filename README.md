...
| Conformance suites (`cauldron verify`) | Working. 647 cases, all from documentation so far |
...
Recipe: 647 cases, none yet run against a live account. Documentation-derived
