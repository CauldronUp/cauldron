...
| Conformance suites (`cauldron verify`) | Working. 553 cases, all from documentation so far |
...
Recipe: 553 cases, none yet run against a live account. Documentation-derived
