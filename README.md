...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 178 of 200 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2113 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2113 cases, 58 run against
a live account and 2055 not. Documentation-derived cases are worth having,
...
The table reaches 178 of the 200 Recipes. The other 22 ship and can be named
