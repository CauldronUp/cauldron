...
| Conformance suites (`cauldron verify`) | Working. 1274 cases, all from documentation so far |
...
Recipe: 1274 cases, none yet run against a live account. Documentation-derived
