...
| Conformance suites (`cauldron verify`) | Working. 1249 cases, all from documentation so far |
...
Recipe: 1249 cases, none yet run against a live account. Documentation-derived
