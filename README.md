...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 203 of 225 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2355 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2355 cases, 58 run against
a live account and 2297 not. Documentation-derived cases are worth having,
...
The table reaches 203 of the 225 Recipes. The other 22 ship and can be named
