...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 176 of 197 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2082 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2082 cases, 58 run against
a live account and 2024 not. Documentation-derived cases are worth having,
...
The table reaches 176 of the 197 Recipes. The other 21 ship and can be named
