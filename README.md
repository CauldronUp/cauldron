...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 521 of 668 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9553 cases, 3369 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9553 cases, 3369 run against
...
All 3369 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 521 of the 668, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 521 of the 668 here -- is served exactly as it
...
The table reaches 521 of the 668 Recipes. The other 147 ship and can be named
