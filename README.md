...
| Conformance suites (`cauldron verify`) | Working. 1367 cases, all from documentation so far |
...
Recipe: 1367 cases, none yet run against a live account. Documentation-derived
