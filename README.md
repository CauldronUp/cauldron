...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 268 of 294 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2954 cases, 639 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2954 cases, 639 run against
...
The six hundred and thirty-nine are the cases whose provider can be asked without a key. Six are
...
The table reaches 268 of the 294 Recipes. The other 26 ship and can be named
