...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 243 of 267 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2752 cases, 437 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2752 cases, 437 run against
...
The four hundred and thirty-seven are the cases whose provider can be asked without a key. Six are
...
The table reaches 243 of the 267 Recipes. The other 24 ship and can be named
