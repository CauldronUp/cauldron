...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 242 of 266 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2741 cases, 426 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2741 cases, 426 run against
...
The four hundred and twenty-six are the cases whose provider can be asked without a key. Six are
...
The table reaches 242 of the 266 Recipes. The other 24 ship and can be named
