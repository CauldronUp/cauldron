...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 201 of 223 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2338 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2338 cases, 58 run against
a live account and 2280 not. Documentation-derived cases are worth having,
...
The table reaches 201 of the 223 Recipes. The other 22 ship and can be named
