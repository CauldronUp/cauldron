...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 200 of 222 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2326 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2326 cases, 58 run against
a live account and 2268 not. Documentation-derived cases are worth having,
...
The table reaches 200 of the 222 Recipes. The other 22 ship and can be named
