...
| Conformance suites (`cauldron verify`) | Working. 434 cases, all from documentation so far |
...
Recipe: 434 cases, none yet run against a live account. Documentation-derived
