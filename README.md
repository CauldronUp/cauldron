...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 264 of 289 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2917 cases, 602 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2917 cases, 602 run against
...
The six hundred and two are the cases whose provider can be asked without a key. Six are
...
The table reaches 264 of the 289 Recipes. The other 25 ship and can be named
