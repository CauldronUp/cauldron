...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 815 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11007 cases, 4025 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11007 cases, 4025 run against
a live account and 6982 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4025 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 565 of the 815, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 565 of the 815 here -- is served exactly as it
...
The table reaches 533 of the 815 Recipes. The other 282 ship and can be named
