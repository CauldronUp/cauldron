...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 515 of 661 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9477 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9477 cases, 3356 run against
a live account and 6121 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 515 of the 661, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 515 of the 661 here -- is served exactly as it
...
The table reaches 515 of the 661 Recipes. The other 146 ship and can be named
