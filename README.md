...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 507 of 652 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9387 cases, 3348 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9387 cases, 3348 run against
a live account and 6039 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 507 of the 652, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 507 of the 652 here -- is served exactly as it
...
The table reaches 507 of the 652 Recipes. The other 145 ship and can be named
