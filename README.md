...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 159 of 179 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1875 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1875 cases, 58 run against
a live account and 1817 not. Documentation-derived cases are worth having,
...
The table reaches 159 of the 179 Recipes. The other 20 ship and can be named
