...
| Conformance suites (`cauldron verify`) | Working. 1449 cases, all from documentation so far |
...
Recipe: 1449 cases, none yet run against a live account. Documentation-derived
