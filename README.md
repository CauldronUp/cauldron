...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 171 of 192 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2028 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2028 cases, 58 run against
a live account and 1970 not. Documentation-derived cases are worth having,
...
The table reaches 171 of the 192 Recipes. The other 21 ship and can be named
