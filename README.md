...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 839 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11260 cases, 4147 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11260 cases, 4147 run against
a live account and 7113 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4147 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 584 of the 839, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 584 of the 839 here -- is served exactly as it
...
The table reaches 533 of the 839 Recipes. The other 306 ship and can be named
