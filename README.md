...
| Conformance suites (`cauldron verify`) | Working. 8241 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 8241 cases, 3309 run against
a live account and 4932 not. Documentation-derived cases are worth having,
