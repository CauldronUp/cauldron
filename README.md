...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 503 of 648 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9340 cases, 3346 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6489 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9340 cases, 3346 run against
a live account and 5994 not. Documentation-derived cases are worth having,
...
**The number will not reach 648.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 503 of the 648, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 503 of the 648 here -- is served exactly as it
...
The table reaches 503 of the 648 Recipes. The other 145 ship and can be named
