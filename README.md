...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 737 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10277 cases, 3717 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10277 cases, 3717 run against
a live account and 6560 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3717 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 523 of the 737, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 523 of the 737 here -- is served exactly as it
...
The table reaches 533 of the 737 Recipes. The other 204 ship and can be named
