...
| Conformance suites (`cauldron verify`) | Working. 1524 cases, all from documentation so far |
...
Recipe: 1524 cases, none yet run against a live account. Documentation-derived
