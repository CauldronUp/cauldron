...
| Conformance suites (`cauldron verify`) | Working. 774 cases, all from documentation so far |
...
Recipe: 774 cases, none yet run against a live account. Documentation-derived
