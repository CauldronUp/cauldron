...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 212 of 236 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2463 cases, 148 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2463 cases, 148 run against
...
The hundred and forty-eight are the cases whose provider can be asked without a key. Six are
...
The table reaches 212 of the 236 Recipes. The other 24 ship and can be named
