...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 519 of 666 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9529 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9529 cases, 3356 run against
a live account and 6173 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 519 of the 666, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 519 of the 666 here -- is served exactly as it
...
The table reaches 519 of the 666 Recipes. The other 147 ship and can be named
