...
| Conformance suites (`cauldron verify`) | Working. 1286 cases, all from documentation so far |
...
Recipe: 1286 cases, none yet run against a live account. Documentation-derived
