...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 262 of 287 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2903 cases, 588 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2903 cases, 588 run against
...
The five hundred and eighty-eight are the cases whose provider can be asked without a key. Six are
...
The table reaches 262 of the 287 Recipes. The other 25 ship and can be named
