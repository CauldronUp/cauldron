...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 211 of 235 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2454 cases, 139 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2454 cases, 139 run against
...
The hundred and thirty-nine are the cases whose provider can be asked without a key. Six are
...
The table reaches 211 of the 235 Recipes. The other 24 ship and can be named
