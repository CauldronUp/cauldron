...
| Conformance suites (`cauldron verify`) | Working. 1238 cases, all from documentation so far |
...
Recipe: 1238 cases, none yet run against a live account. Documentation-derived
