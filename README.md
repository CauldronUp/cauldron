...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 167 of 188 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1976 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1976 cases, 58 run against
a live account and 1918 not. Documentation-derived cases are worth having,
...
The table reaches 167 of the 188 Recipes. The other 21 ship and can be named
