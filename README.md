...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 791 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10778 cases, 3931 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10778 cases, 3931 run against
a live account and 6847 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3931 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 556 of the 791, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 556 of the 791 here -- is served exactly as it
...
The table reaches 533 of the 791 Recipes. The other 258 ship and can be named
