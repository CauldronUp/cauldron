...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 174 of 195 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2060 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2060 cases, 58 run against
a live account and 2002 not. Documentation-derived cases are worth having,
...
The table reaches 174 of the 195 Recipes. The other 21 ship and can be named
