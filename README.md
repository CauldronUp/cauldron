...
| Conformance suites (`cauldron verify`) | Working. 8816 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 8816 cases, 3309 run against
a live account and 5507 not. Documentation-derived cases are worth having,
