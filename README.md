...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 175 of 196 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2071 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2071 cases, 58 run against
a live account and 2013 not. Documentation-derived cases are worth having,
...
The table reaches 175 of the 196 Recipes. The other 21 ship and can be named
