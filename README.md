...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 502 of 647 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9329 cases, 3346 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6479 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9329 cases, 3346 run against
a live account and 5983 not. Documentation-derived cases are worth having,
...
**The number will not reach 647.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 502 of the 647, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 502 of the 647 here -- is served exactly as it
...
The table reaches 502 of the 647 Recipes. The other 145 ship and can be named
