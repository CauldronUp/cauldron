...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 255 of 279 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2840 cases, 525 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2840 cases, 525 run against
...
The five hundred and twenty-five are the cases whose provider can be asked without a key. Six are
...
The table reaches 255 of the 279 Recipes. The other 24 ship and can be named
