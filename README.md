...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 257 of 281 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2855 cases, 540 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2855 cases, 540 run against
...
The five hundred and forty are the cases whose provider can be asked without a key. Six are
...
The table reaches 257 of the 281 Recipes. The other 24 ship and can be named
