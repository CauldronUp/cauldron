...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 188 of 210 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2224 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2224 cases, 58 run against
a live account and 2166 not. Documentation-derived cases are worth having,
...
The table reaches 188 of the 210 Recipes. The other 22 ship and can be named
