...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 830 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11171 cases, 4105 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11171 cases, 4105 run against
a live account and 7066 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4105 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 575 of the 830, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 575 of the 830 here -- is served exactly as it
...
The table reaches 533 of the 830 Recipes. The other 297 ship and can be named
