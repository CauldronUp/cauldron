...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 776 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10636 cases, 3865 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10636 cases, 3865 run against
...
All 3865 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 550 of the 776, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 550 of the 776 here -- is served exactly as it
...
The table reaches 533 of the 776 Recipes. The other 243 ship and can be named
