...
| Conformance suites (`cauldron verify`) | Working. 1035 cases, all from documentation so far |
...
Recipe: 1035 cases, none yet run against a live account. Documentation-derived
