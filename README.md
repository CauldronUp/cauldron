...
| Conformance suites (`cauldron verify`) | Working. 630 cases, all from documentation so far |
...
Recipe: 630 cases, none yet run against a live account. Documentation-derived
