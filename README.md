...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 186 of 208 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2201 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2201 cases, 58 run against
a live account and 2143 not. Documentation-derived cases are worth having,
...
The table reaches 186 of the 208 Recipes. The other 22 ship and can be named
