...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 734 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10249 cases, 3697 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10249 cases, 3697 run against
...
All 3697 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 520 of the 734, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 520 of the 734 here -- is served exactly as it
...
The table reaches 533 of the 734 Recipes. The other 201 ship and can be named
