...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 765 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10541 cases, 3829 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10541 cases, 3829 run against
...
All 3829 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 542 of the 765, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 542 of the 765 here -- is served exactly as it
...
The table reaches 533 of the 765 Recipes. The other 232 ship and can be named
