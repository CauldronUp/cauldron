...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 489 of 634 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9192 cases, 3313 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9192 cases, 3313 run against
a live account and 5879 not. Documentation-derived cases are worth having,
...
**The number will not reach 634.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 634, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 634 here -- is served exactly as it
...
The table reaches 489 of the 634 Recipes. The other 145 ship and can be named
