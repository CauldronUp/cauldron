...
| Conformance suites (`cauldron verify`) | Working. 1092 cases, all from documentation so far |
...
Recipe: 1092 cases, none yet run against a live account. Documentation-derived
