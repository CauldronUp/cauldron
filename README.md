...
| Conformance suites (`cauldron verify`) | Working. 1177 cases, all from documentation so far |
...
Recipe: 1177 cases, none yet run against a live account. Documentation-derived
