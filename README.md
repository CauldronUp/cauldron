...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 838 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11252 cases, 4142 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11252 cases, 4142 run against
a live account and 7110 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4142 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 583 of the 838, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 583 of the 838 here -- is served exactly as it
...
The table reaches 533 of the 838 Recipes. The other 305 ship and can be named
