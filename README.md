...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 166 of 187 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1965 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1965 cases, 58 run against
a live account and 1907 not. Documentation-derived cases are worth having,
...
The table reaches 166 of the 187 Recipes. The other 21 ship and can be named
