...
| Conformance suites (`cauldron verify`) | Working. 656 cases, all from documentation so far |
...
Recipe: 656 cases, none yet run against a live account. Documentation-derived
