...
| Conformance suites (`cauldron verify`) | Working. 1698 cases, 51 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1698 cases, 51 run against
