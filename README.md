...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 227 of 251 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2604 cases, 289 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2604 cases, 289 run against
...
The two hundred and eighty-nine are the cases whose provider can be asked without a key. Six are
...
The table reaches 227 of the 251 Recipes. The other 24 ship and can be named
