...
| Conformance suites (`cauldron verify`) | Working. 1201 cases, all from documentation so far |
...
Recipe: 1201 cases, none yet run against a live account. Documentation-derived
