...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 713 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10002 cases, 3583 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10002 cases, 3583 run against
a live account and 6419 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3583 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 505 of the 713, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 505 of the 713 here -- is served exactly as it
...
The table reaches 533 of the 713 Recipes. The other 180 ship and can be named
