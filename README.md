...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 179 of 201 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2123 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2123 cases, 58 run against
a live account and 2065 not. Documentation-derived cases are worth having,
...
The table reaches 179 of the 201 Recipes. The other 22 ship and can be named
