...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 208 of 231 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2415 cases, 100 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2415 cases, 100 run against
...
The hundred are the cases whose provider can be asked without a key. Six are
...
The table reaches 208 of the 231 Recipes. The other 23 ship and can be named
