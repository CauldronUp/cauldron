...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 759 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10487 cases, 3806 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10487 cases, 3806 run against
...
All 3806 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 539 of the 759, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 539 of the 759 here -- is served exactly as it
...
The table reaches 533 of the 759 Recipes. The other 226 ship and can be named
