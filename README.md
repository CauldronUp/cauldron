...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 771 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10590 cases, 3853 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10590 cases, 3853 run against
a live account and 6737 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3853 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 546 of the 771, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 546 of the 771 here -- is served exactly as it
...
The table reaches 533 of the 771 Recipes. The other 238 ship and can be named
