...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 494 of 639 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9245 cases, 3342 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6399 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9245 cases, 3342 run against
a live account and 5903 not. Documentation-derived cases are worth having,
...
**The number will not reach 639.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 639, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 639 here -- is served exactly as it
...
The table reaches 494 of the 639 Recipes. The other 145 ship and can be named
