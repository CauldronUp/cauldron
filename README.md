...
| Conformance suites (`cauldron verify`) | Working. 1312 cases, all from documentation so far |
...
Recipe: 1312 cases, none yet run against a live account. Documentation-derived
