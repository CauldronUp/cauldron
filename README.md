...
| Conformance suites (`cauldron verify`) | Working. 1154 cases, all from documentation so far |
...
Recipe: 1154 cases, none yet run against a live account. Documentation-derived
