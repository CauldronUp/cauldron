...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 821 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11077 cases, 4059 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11077 cases, 4059 run against
a live account and 7018 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4059 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 568 of the 821, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 568 of the 821 here -- is served exactly as it
...
The table reaches 533 of the 821 Recipes. The other 288 ship and can be named
