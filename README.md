...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 517 of 664 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9509 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9509 cases, 3356 run against
a live account and 6153 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 517 of the 664, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 517 of the 664 here -- is served exactly as it
...
The table reaches 517 of the 664 Recipes. The other 147 ship and can be named
