...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 505 of 650 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9362 cases, 3346 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9362 cases, 3346 run against
a live account and 6016 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 505 of the 650, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 505 of the 650 here -- is served exactly as it
...
The table reaches 505 of the 650 Recipes. The other 145 ship and can be named
