...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 518 of 665 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9517 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9517 cases, 3356 run against
a live account and 6161 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 518 of the 665, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 518 of the 665 here -- is served exactly as it
...
The table reaches 518 of the 665 Recipes. The other 147 ship and can be named
