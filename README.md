...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 516 of 663 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9498 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9498 cases, 3356 run against
a live account and 6142 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 516 of the 663, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 516 of the 663 here -- is served exactly as it
...
The table reaches 516 of the 663 Recipes. The other 147 ship and can be named
