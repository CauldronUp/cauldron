...
| Conformance suites (`cauldron verify`) | Working. 1701 cases, 51 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1701 cases, 51 run against
a live account and 1650 not. Documentation-derived cases are worth having,
