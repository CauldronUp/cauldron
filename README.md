...
| Conformance suites (`cauldron verify`) | Working. 8280 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 8280 cases, 3309 run against
a live account and 4971 not. Documentation-derived cases are worth having,
