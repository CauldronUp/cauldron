...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 260 of 285 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2888 cases, 573 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2888 cases, 573 run against
...
The five hundred and seventy-three are the cases whose provider can be asked without a key. Six are
...
The table reaches 260 of the 285 Recipes. The other 25 ship and can be named
