...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 258 of 282 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2863 cases, 548 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2863 cases, 548 run against
...
The five hundred and forty-eight are the cases whose provider can be asked without a key. Six are
...
The table reaches 258 of the 282 Recipes. The other 24 ship and can be named
