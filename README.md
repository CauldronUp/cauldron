...
| Conformance suites (`cauldron verify`) | Working. 6791 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 6791 cases, 3309 run against
a live account and 3482 not. Documentation-derived cases are worth having,
