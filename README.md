...
| Conformance suites (`cauldron verify`) | Working. 1532 cases, all from documentation so far |
...
Recipe: 1532 cases, none yet run against a live account. Documentation-derived
