...
| Conformance suites (`cauldron verify`) | Working. 579 cases, all from documentation so far |
...
Recipe: 579 cases, none yet run against a live account. Documentation-derived
