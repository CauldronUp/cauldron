...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 263 of 288 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2910 cases, 595 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2910 cases, 595 run against
...
The five hundred and ninety-five are the cases whose provider can be asked without a key. Six are
...
The table reaches 263 of the 288 Recipes. The other 25 ship and can be named
