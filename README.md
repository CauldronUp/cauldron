...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 486 of 629 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9138 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9138 cases, 3309 run against
a live account and 5829 not. Documentation-derived cases are worth having,
...
**The number will not reach 629.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 629, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 629 here -- is served exactly as it
...
The table reaches 486 of the 629 Recipes. The other 143 ship and can be named
