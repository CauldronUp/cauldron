...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 187 of 209 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2212 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2212 cases, 58 run against
a live account and 2154 not. Documentation-derived cases are worth having,
...
The table reaches 187 of the 209 Recipes. The other 22 ship and can be named
