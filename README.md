...
| Conformance suites (`cauldron verify`) | Working. 790 cases, all from documentation so far |
...
Recipe: 790 cases, none yet run against a live account. Documentation-derived
