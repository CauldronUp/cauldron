...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 164 of 185 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1942 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1942 cases, 58 run against
a live account and 1884 not. Documentation-derived cases are worth having,
...
The table reaches 164 of the 185 Recipes. The other 21 ship and can be named
