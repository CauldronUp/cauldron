...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 154 of 174 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1823 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1823 cases, 58 run against
a live account and 1765 not. Documentation-derived cases are worth having,
...
The table reaches 154 of the 174 Recipes. The other 20 ship and can be named
