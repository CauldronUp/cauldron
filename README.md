...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 327 of 375 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 3702 cases, 1199 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 3702 cases, 1199 run against
a live account and 2503 not. Documentation-derived cases are worth having,
...
**The number will not reach 375.** Most providers publish nothing, and this
...
The table reaches 327 of the 375 Recipes. The other 48 ship and can be named
