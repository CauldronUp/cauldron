...
| Conformance suites (`cauldron verify`) | Working. 1067 cases, all from documentation so far |
...
Recipe: 1067 cases, none yet run against a live account. Documentation-derived
