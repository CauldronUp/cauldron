...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 177 of 199 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2101 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2101 cases, 58 run against
a live account and 2043 not. Documentation-derived cases are worth having,
...
The table reaches 177 of the 199 Recipes. The other 22 ship and can be named
