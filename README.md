...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 508 of 653 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9396 cases, 3348 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9396 cases, 3348 run against
a live account and 6048 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 508 of the 653, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 508 of the 653 here -- is served exactly as it
...
The table reaches 508 of the 653 Recipes. The other 145 ship and can be named
