...
| Conformance suites (`cauldron verify`) | Working. 43 cases, all from documentation so far |
...
| Recipes shipped | Stripe, GitHub, Shopify, Twilio, Slack, HubSpot |
...
Recipe: 43 cases, none yet run against a live account. Documentation-derived
