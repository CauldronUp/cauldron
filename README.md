...
| Conformance suites (`cauldron verify`) | Working. 1751 cases, 56 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1751 cases, 56 run against
