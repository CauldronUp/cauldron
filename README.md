...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 833 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11202 cases, 4118 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11202 cases, 4118 run against
a live account and 7084 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4118 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 578 of the 833, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 578 of the 833 here -- is served exactly as it
...
The table reaches 533 of the 833 Recipes. The other 300 ship and can be named
