...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 156 of 176 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1843 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1843 cases, 58 run against
a live account and 1785 not. Documentation-derived cases are worth having,
...
The table reaches 156 of the 176 Recipes. The other 20 ship and can be named
