...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 245 of 269 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2768 cases, 453 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2768 cases, 453 run against
...
The four hundred and fifty-three are the cases whose provider can be asked without a key. Six are
...
The table reaches 245 of the 269 Recipes. The other 24 ship and can be named
