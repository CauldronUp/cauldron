...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 265 of 290 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2925 cases, 610 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2925 cases, 610 run against
...
The six hundred and ten are the cases whose provider can be asked without a key. Six are
...
The table reaches 265 of the 290 Recipes. The other 25 ship and can be named
