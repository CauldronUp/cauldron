...
| Conformance suites (`cauldron verify`) | Working. 6515 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 6515 cases, 3309 run against
a live account and 3206 not. Documentation-derived cases are worth having,
