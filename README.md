...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 149 of 169 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1773 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1773 cases, 58 run against
a live account and 1715 not. Documentation-derived cases are worth having,
...
The table reaches 149 of the 169 Recipes. The other 20 ship and can be named
