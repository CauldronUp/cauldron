...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 152 of 172 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1804 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1804 cases, 58 run against
a live account and 1746 not. Documentation-derived cases are worth having,
...
The table reaches 152 of the 172 Recipes. The other 20 ship and can be named
