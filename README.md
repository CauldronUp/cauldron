...
| Conformance suites (`cauldron verify`) | Working. 1054 cases, all from documentation so far |
...
Recipe: 1054 cases, none yet run against a live account. Documentation-derived
