...
| Conformance suites (`cauldron verify`) | Working. 1299 cases, all from documentation so far |
...
Recipe: 1299 cases, none yet run against a live account. Documentation-derived
