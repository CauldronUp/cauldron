...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 198 of 220 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2308 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2308 cases, 58 run against
a live account and 2250 not. Documentation-derived cases are worth having,
...
The table reaches 198 of the 220 Recipes. The other 22 ship and can be named
