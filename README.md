...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 185 of 207 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2190 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2190 cases, 58 run against
a live account and 2132 not. Documentation-derived cases are worth having,
...
The table reaches 185 of the 207 Recipes. The other 22 ship and can be named
