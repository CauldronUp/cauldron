...
| Conformance suites (`cauldron verify`) | Working. 613 cases, all from documentation so far |
...
Recipe: 613 cases, none yet run against a live account. Documentation-derived
