...
| Conformance suites (`cauldron verify`) | Working. 1432 cases, all from documentation so far |
...
Recipe: 1432 cases, none yet run against a live account. Documentation-derived
