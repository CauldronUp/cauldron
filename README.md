...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 217 of 241 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2519 cases, 204 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2519 cases, 204 run against
...
The two hundred and four are the cases whose provider can be asked without a key. Six are
...
The table reaches 217 of the 241 Recipes. The other 24 ship and can be named
