...
| Conformance suites (`cauldron verify`) | Working. 1480 cases, all from documentation so far |
...
Recipe: 1480 cases, none yet run against a live account. Documentation-derived
