...
| Conformance suites (`cauldron verify`) | Working. 673 cases, all from documentation so far |
...
Recipe: 673 cases, none yet run against a live account. Documentation-derived
