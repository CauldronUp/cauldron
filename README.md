...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 199 of 221 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2317 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2317 cases, 58 run against
a live account and 2259 not. Documentation-derived cases are worth having,
...
The table reaches 199 of the 221 Recipes. The other 22 ship and can be named
