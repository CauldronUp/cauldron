...
| Conformance suites (`cauldron verify`) | Working. 1189 cases, all from documentation so far |
...
Recipe: 1189 cases, none yet run against a live account. Documentation-derived
