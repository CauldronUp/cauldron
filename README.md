...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 172 of 193 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2039 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2039 cases, 58 run against
a live account and 1981 not. Documentation-derived cases are worth having,
...
The table reaches 172 of the 193 Recipes. The other 21 ship and can be named
