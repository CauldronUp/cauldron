...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 747 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10382 cases, 3764 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10382 cases, 3764 run against
a live account and 6618 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 530 of the 747, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 530 of the 747 here -- is served exactly as it
...
The table reaches 533 of the 747 Recipes. The other 214 ship and can be named
