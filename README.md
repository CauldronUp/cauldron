...
| Conformance suites (`cauldron verify`) | Working. 6641 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 6641 cases, 3309 run against
a live account and 3332 not. Documentation-derived cases are worth having,
