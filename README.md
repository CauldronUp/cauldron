...
| Conformance suites (`cauldron verify`) | Working. 443 cases, all from documentation so far |
...
Recipe: 443 cases, none yet run against a live account. Documentation-derived
