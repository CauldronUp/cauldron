...
| Conformance suites (`cauldron verify`) | Working. 1541 cases, all from documentation so far |
...
Recipe: 1541 cases, none yet run against a live account. Documentation-derived
