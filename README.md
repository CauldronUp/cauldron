...
| Conformance suites (`cauldron verify`) | Working. 1501 cases, all from documentation so far |
...
Recipe: 1501 cases, none yet run against a live account. Documentation-derived
