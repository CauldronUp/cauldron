...
| Conformance suites (`cauldron verify`) | Working. 571 cases, all from documentation so far |
...
Recipe: 571 cases, none yet run against a live account. Documentation-derived
