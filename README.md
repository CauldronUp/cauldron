...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 194 of 216 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2277 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2277 cases, 58 run against
a live account and 2219 not. Documentation-derived cases are worth having,
...
The table reaches 194 of the 216 Recipes. The other 22 ship and can be named
