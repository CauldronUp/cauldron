...
| Conformance suites (`cauldron verify`) | Working. 835 cases, all from documentation so far |
...
Recipe: 835 cases, none yet run against a live account. Documentation-derived
