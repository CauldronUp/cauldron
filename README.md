...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 832 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11190 cases, 4113 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11190 cases, 4113 run against
a live account and 7077 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4113 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 577 of the 832, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 577 of the 832 here -- is served exactly as it
...
The table reaches 533 of the 832 Recipes. The other 299 ship and can be named
