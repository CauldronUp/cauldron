...
| Conformance suites (`cauldron verify`) | Working. 1387 cases, all from documentation so far |
...
Recipe: 1387 cases, none yet run against a live account. Documentation-derived
