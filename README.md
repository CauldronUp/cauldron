...
| Conformance suites (`cauldron verify`) | Working. 1516 cases, all from documentation so far |
...
Recipe: 1516 cases, none yet run against a live account. Documentation-derived
