...
| Conformance suites (`cauldron verify`) | Working. 1119 cases, all from documentation so far |
...
Recipe: 1119 cases, none yet run against a live account. Documentation-derived
