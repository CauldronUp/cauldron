...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 161 of 182 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1909 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1909 cases, 58 run against
a live account and 1851 not. Documentation-derived cases are worth having,
...
The table reaches 161 of the 182 Recipes. The other 21 ship and can be named
