...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 195 of 217 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2284 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2284 cases, 58 run against
a live account and 2226 not. Documentation-derived cases are worth having,
...
The table reaches 195 of the 217 Recipes. The other 22 ship and can be named
