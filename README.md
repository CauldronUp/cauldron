...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 173 of 194 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2050 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2050 cases, 58 run against
a live account and 1992 not. Documentation-derived cases are worth having,
...
The table reaches 173 of the 194 Recipes. The other 21 ship and can be named
