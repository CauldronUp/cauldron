...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 520 of 667 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9540 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9540 cases, 3356 run against
...
All 3356 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 520 of the 667, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 520 of the 667 here -- is served exactly as it
...
The table reaches 520 of the 667 Recipes. The other 147 ship and can be named
