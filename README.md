...
| Conformance suites (`cauldron verify`) | Working. 10191 cases, 3672 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10191 cases, 3672 run against
...
All 3672 are the cases whose provider can be asked without a key. Every other
