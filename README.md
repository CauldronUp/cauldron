...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 488 of 633 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9179 cases, 3313 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9179 cases, 3313 run against
a live account and 5866 not. Documentation-derived cases are worth having,
...
**The number will not reach 633.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 633, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 633 here -- is served exactly as it
...
The table reaches 488 of the 633 Recipes. The other 145 ship and can be named
