...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 244 of 268 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2759 cases, 444 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2759 cases, 444 run against
...
The four hundred and forty-four are the cases whose provider can be asked without a key. Six are
...
The table reaches 244 of the 268 Recipes. The other 24 ship and can be named
