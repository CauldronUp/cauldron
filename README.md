...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 165 of 186 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1953 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1953 cases, 58 run against
a live account and 1895 not. Documentation-derived cases are worth having,
...
The table reaches 165 of the 186 Recipes. The other 21 ship and can be named
