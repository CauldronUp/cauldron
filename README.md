...
| Conformance suites (`cauldron verify`) | Working. 1461 cases, all from documentation so far |
...
Recipe: 1461 cases, none yet run against a live account. Documentation-derived
