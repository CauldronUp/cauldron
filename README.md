...
| Conformance suites (`cauldron verify`) | Working. 807 cases, all from documentation so far |
...
Recipe: 807 cases, none yet run against a live account. Documentation-derived
