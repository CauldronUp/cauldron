...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 261 of 286 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2895 cases, 580 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2895 cases, 580 run against
...
The five hundred and eighty are the cases whose provider can be asked without a key. Six are
...
The table reaches 261 of the 286 Recipes. The other 25 ship and can be named
