...
| Conformance suites (`cauldron verify`) | Working. 1213 cases, all from documentation so far |
...
Recipe: 1213 cases, none yet run against a live account. Documentation-derived
