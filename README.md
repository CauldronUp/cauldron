...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 204 of 226 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2363 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2363 cases, 58 run against
a live account and 2305 not. Documentation-derived cases are worth having,
...
The table reaches 204 of the 226 Recipes. The other 22 ship and can be named
