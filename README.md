...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 744 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10352 cases, 3751 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10352 cases, 3751 run against
a live account and 6601 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3751 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 527 of the 744, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 527 of the 744 here -- is served exactly as it
...
The table reaches 533 of the 744 Recipes. The other 211 ship and can be named
