...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 158 of 178 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1864 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1864 cases, 58 run against
a live account and 1806 not. Documentation-derived cases are worth having,
...
The table reaches 158 of the 178 Recipes. The other 20 ship and can be named
