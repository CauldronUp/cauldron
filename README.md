...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 184 of 206 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2179 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2179 cases, 58 run against
a live account and 2121 not. Documentation-derived cases are worth having,
...
The table reaches 184 of the 206 Recipes. The other 22 ship and can be named
