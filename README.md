...
| Conformance suites (`cauldron verify`) | Working. 1143 cases, all from documentation so far |
...
Recipe: 1143 cases, none yet run against a live account. Documentation-derived
