...
| Conformance suites (`cauldron verify`) | Working. 596 cases, all from documentation so far |
...
Recipe: 596 cases, none yet run against a live account. Documentation-derived
