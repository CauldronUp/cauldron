...
| Conformance suites (`cauldron verify`) | Working. 700 cases, all from documentation so far |
...
Recipe: 700 cases, none yet run against a live account. Documentation-derived
