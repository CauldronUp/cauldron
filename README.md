...
| Conformance suites (`cauldron verify`) | Working. 605 cases, all from documentation so far |
...
Recipe: 605 cases, none yet run against a live account. Documentation-derived
