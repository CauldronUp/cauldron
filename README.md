...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 208 of 232 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2423 cases, 108 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2423 cases, 108 run against
...
The hundred and eight are the cases whose provider can be asked without a key. Six are
...
The table reaches 208 of the 232 Recipes. The other 24 ship and can be named
