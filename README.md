...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 269 of 295 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2961 cases, 646 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2961 cases, 646 run against
...
The six hundred and forty-six are the cases whose provider can be asked without a key. Six are
...
The table reaches 269 of the 295 Recipes. The other 26 ship and can be named
