...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 228 of 252 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2612 cases, 297 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2612 cases, 297 run against
...
The two hundred and ninety-seven are the cases whose provider can be asked without a key. Six are
...
The table reaches 228 of the 252 Recipes. The other 24 ship and can be named
