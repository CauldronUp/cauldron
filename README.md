...
| Conformance suites (`cauldron verify`) | Working. 562 cases, all from documentation so far |
...
Recipe: 562 cases, none yet run against a live account. Documentation-derived
