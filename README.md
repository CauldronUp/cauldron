...
| Conformance suites (`cauldron verify`) | Working. 527 cases, all from documentation so far |
...
Recipe: 527 cases, none yet run against a live account. Documentation-derived
