...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 155 of 175 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1833 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1833 cases, 58 run against
a live account and 1775 not. Documentation-derived cases are worth having,
...
The table reaches 155 of the 175 Recipes. The other 20 ship and can be named
