...
| Conformance suites (`cauldron verify`) | Working. 760 cases, all from documentation so far |
...
Recipe: 760 cases, none yet run against a live account. Documentation-derived
