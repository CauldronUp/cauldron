...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 498 of 643 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9287 cases, 3342 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6439 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9287 cases, 3342 run against
a live account and 5945 not. Documentation-derived cases are worth having,
...
**The number will not reach 643.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 643, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 643 here -- is served exactly as it
...
The table reaches 498 of the 643 Recipes. The other 145 ship and can be named
