...
| Conformance suites (`cauldron verify`) | Working. 1688 cases, 18 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1688 cases, 18 run against
