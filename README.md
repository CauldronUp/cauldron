...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 816 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11019 cases, 4029 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11019 cases, 4029 run against
a live account and 6990 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4029 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 565 of the 816, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 565 of the 816 here -- is served exactly as it
...
The table reaches 533 of the 816 Recipes. The other 283 ship and can be named
