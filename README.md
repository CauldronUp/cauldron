...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 247 of 271 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2783 cases, 468 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2783 cases, 468 run against
...
The four hundred and sixty-eight are the cases whose provider can be asked without a key. Six are
...
The table reaches 247 of the 271 Recipes. The other 24 ship and can be named
