...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 496 of 641 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9265 cases, 3342 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6419 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9265 cases, 3342 run against
a live account and 5923 not. Documentation-derived cases are worth having,
...
**The number will not reach 641.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 641, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 641 here -- is served exactly as it
...
The table reaches 496 of the 641 Recipes. The other 145 ship and can be named
