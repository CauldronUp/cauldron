...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 253 of 277 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2824 cases, 509 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2824 cases, 509 run against
...
The five hundred and nine are the cases whose provider can be asked without a key. Six are
...
The table reaches 253 of the 277 Recipes. The other 24 ship and can be named
