...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 486 of 630 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9148 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9148 cases, 3309 run against
a live account and 5839 not. Documentation-derived cases are worth having,
...
**The number will not reach 630.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 630, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 630 here -- is served exactly as it
...
The table reaches 486 of the 630 Recipes. The other 144 ship and can be named
