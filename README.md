...
| Conformance suites (`cauldron verify`) | Working. 1699 cases, 51 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1699 cases, 51 run against
a live account and 1648 not. Documentation-derived cases are worth having,
