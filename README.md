...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 197 of 219 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2300 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2300 cases, 58 run against
a live account and 2242 not. Documentation-derived cases are worth having,
...
The table reaches 197 of the 219 Recipes. The other 22 ship and can be named
