...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 231 of 255 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2636 cases, 321 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2636 cases, 321 run against
...
The three hundred and twenty-one are the cases whose provider can be asked without a key. Six are
...
The table reaches 231 of the 255 Recipes. The other 24 ship and can be named
