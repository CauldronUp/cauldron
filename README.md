...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 170 of 191 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2016 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2016 cases, 58 run against
a live account and 1958 not. Documentation-derived cases are worth having,
...
The table reaches 170 of the 191 Recipes. The other 21 ship and can be named
