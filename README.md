...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 196 of 218 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2293 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2293 cases, 58 run against
a live account and 2235 not. Documentation-derived cases are worth having,
...
The table reaches 196 of the 218 Recipes. The other 22 ship and can be named
