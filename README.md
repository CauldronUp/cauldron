...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 827 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11140 cases, 4091 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11140 cases, 4091 run against
a live account and 7049 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4091 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 573 of the 827, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 573 of the 827 here -- is served exactly as it
...
The table reaches 533 of the 827 Recipes. The other 294 ship and can be named
