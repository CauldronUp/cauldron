...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 510 of 655 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9416 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9416 cases, 3356 run against
a live account and 6060 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 510 of the 655, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 510 of the 655 here -- is served exactly as it
...
The table reaches 510 of the 655 Recipes. The other 145 ship and can be named
