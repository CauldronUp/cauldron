...
| Conformance suites (`cauldron verify`) | Working. 9086 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9086 cases, 3309 run against
a live account and 5777 not. Documentation-derived cases are worth having,
