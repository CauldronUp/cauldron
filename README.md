...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 767 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10557 cases, 3837 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10557 cases, 3837 run against
...
All 3837 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 543 of the 767, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 543 of the 767 here -- is served exactly as it
...
The table reaches 533 of the 767 Recipes. The other 234 ship and can be named
