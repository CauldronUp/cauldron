...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 819 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11057 cases, 4048 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11057 cases, 4048 run against
a live account and 7009 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4048 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 566 of the 819, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 566 of the 819 here -- is served exactly as it
...
The table reaches 533 of the 819 Recipes. The other 286 ship and can be named
