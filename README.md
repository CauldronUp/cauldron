...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 246 of 270 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2775 cases, 460 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2775 cases, 460 run against
...
The four hundred and sixty are the cases whose provider can be asked without a key. Six are
...
The table reaches 246 of the 270 Recipes. The other 24 ship and can be named
