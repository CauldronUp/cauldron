...
| Conformance suites (`cauldron verify`) | Working. 1690 cases, 18 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1690 cases, 18 run against
a live account and 1672 not. Documentation-derived cases are worth having,
