...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 160 of 181 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1899 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1899 cases, 58 run against
a live account and 1841 not. Documentation-derived cases are worth having,
...
The table reaches 160 of the 181 Recipes. The other 21 ship and can be named
