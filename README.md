...
| Conformance suites (`cauldron verify`) | Working. 1472 cases, all from documentation so far |
...
Recipe: 1472 cases, none yet run against a live account. Documentation-derived
