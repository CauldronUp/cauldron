...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 501 of 646 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9318 cases, 3346 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6469 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9318 cases, 3346 run against
a live account and 5972 not. Documentation-derived cases are worth having,
...
**The number will not reach 646.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 646, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 646 here -- is served exactly as it
...
The table reaches 501 of the 646 Recipes. The other 145 ship and can be named
