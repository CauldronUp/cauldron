...
| Conformance suites (`cauldron verify`) | Working. 1261 cases, all from documentation so far |
...
Recipe: 1261 cases, none yet run against a live account. Documentation-derived
