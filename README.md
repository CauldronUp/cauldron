...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 189 of 211 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2233 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2233 cases, 58 run against
a live account and 2175 not. Documentation-derived cases are worth having,
...
The table reaches 189 of the 211 Recipes. The other 22 ship and can be named
