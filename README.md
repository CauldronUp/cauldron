...
| Conformance suites (`cauldron verify`) | Working. 1078 cases, all from documentation so far |
...
Recipe: 1078 cases, none yet run against a live account. Documentation-derived
