...
| Conformance suites (`cauldron verify`) | Working. 1326 cases, all from documentation so far |
...
Recipe: 1326 cases, none yet run against a live account. Documentation-derived
