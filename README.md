...
| Conformance suites (`cauldron verify`) | Working. 1130 cases, all from documentation so far |
...
Recipe: 1130 cases, none yet run against a live account. Documentation-derived
