...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 792 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10791 cases, 3935 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10791 cases, 3935 run against
a live account and 6856 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3935 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 556 of the 792, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 556 of the 792 here -- is served exactly as it
...
The table reaches 533 of the 792 Recipes. The other 259 ship and can be named
