...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 157 of 177 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1854 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1854 cases, 58 run against
a live account and 1796 not. Documentation-derived cases are worth having,
...
The table reaches 157 of the 177 Recipes. The other 20 ship and can be named
