...
| Conformance suites (`cauldron verify`) | Working. 1666 cases, 5 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1666 cases, 5 run against
