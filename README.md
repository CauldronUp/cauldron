...
| Conformance suites (`cauldron verify`) | Working. 452 cases, all from documentation so far |
...
Recipe: 452 cases, none yet run against a live account. Documentation-derived
