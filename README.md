...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 742 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 10333 cases, 3744 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 10333 cases, 3744 run against
a live account and 6589 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 3744 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 526 of the 742, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 526 of the 742 here -- is served exactly as it
...
The table reaches 533 of the 742 Recipes. The other 209 ship and can be named
