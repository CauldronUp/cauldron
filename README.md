...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 826 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11131 cases, 4087 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11131 cases, 4087 run against
a live account and 7044 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4087 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 572 of the 826, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 572 of the 826 here -- is served exactly as it
...
The table reaches 533 of the 826 Recipes. The other 293 ship and can be named
