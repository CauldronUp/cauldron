...
| Conformance suites (`cauldron verify`) | Working. 639 cases, all from documentation so far |
...
Recipe: 639 cases, none yet run against a live account. Documentation-derived
