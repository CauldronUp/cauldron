...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 229 of 253 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2620 cases, 305 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2620 cases, 305 run against
...
The three hundred and five are the cases whose provider can be asked without a key. Six are
...
The table reaches 229 of the 253 Recipes. The other 24 ship and can be named
