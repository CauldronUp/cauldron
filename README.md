...
| Conformance suites (`cauldron verify`) | Working. 745 cases, all from documentation so far |
...
Recipe: 745 cases, none yet run against a live account. Documentation-derived
