...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 209 of 233 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2434 cases, 119 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2434 cases, 119 run against
...
The hundred and nineteen are the cases whose provider can be asked without a key. Six are
...
The table reaches 209 of the 233 Recipes. The other 24 ship and can be named
