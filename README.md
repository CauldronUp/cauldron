...
| Conformance suites (`cauldron verify`) | Working. 6441 cases, 3308 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 6441 cases, 3308 run against
a live account and 3133 not. Documentation-derived cases are worth having,
