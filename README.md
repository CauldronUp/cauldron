...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 234 of 258 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2659 cases, 344 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2659 cases, 344 run against
...
The three hundred and forty-four are the cases whose provider can be asked without a key. Six are
...
The table reaches 234 of the 258 Recipes. The other 24 ship and can be named
