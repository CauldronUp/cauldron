...
| Conformance suites (`cauldron verify`) | Working. 7421 cases, 3309 of them checked against a live API |
...
stripe 0.1.0
  ...
  4 checked against the real API, 13 from documentation only
  last checked against the real API on 2026-09-05
```

That second line is the honest one. Of every Recipe: 7421 cases, 3309 run against
a live account and 4112 not. Documentation-derived cases are worth having,
