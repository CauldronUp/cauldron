...
| Conformance suites (`cauldron verify`) | Working. 1406 cases, all from documentation so far |
...
Recipe: 1406 cases, none yet run against a live account. Documentation-derived
