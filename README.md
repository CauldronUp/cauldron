...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 150 of 170 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1784 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1784 cases, 58 run against
a live account and 1726 not. Documentation-derived cases are worth having,
...
The table reaches 150 of the 170 Recipes. The other 20 ship and can be named
