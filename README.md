...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 511 of 656 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9424 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9424 cases, 3356 run against
a live account and 6068 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 511 of the 656, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 511 of the 656 here -- is served exactly as it
...
The table reaches 511 of the 656 Recipes. The other 145 ship and can be named
