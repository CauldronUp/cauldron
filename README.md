...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 533 of 822 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 11090 cases, 4066 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 11090 cases, 4066 run against
a live account and 7024 not. Documentation-derived cases are worth having,
and they are not the same as watching the provider do it. Adding a `verified:`
date to a case is a claim that someone did.

All 4066 are the cases whose provider can be asked without a key. Every other
...
| `undeclared` | No description is recorded for this Recipe. 569 of the 822, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 569 of the 822 here -- is served exactly as it
...
The table reaches 533 of the 822 Recipes. The other 289 ship and can be named
