...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 191 of 213 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2252 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2252 cases, 58 run against
a live account and 2194 not. Documentation-derived cases are worth having,
...
The table reaches 191 of the 213 Recipes. The other 22 ship and can be named
