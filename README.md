...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 515 of 662 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9487 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9487 cases, 3356 run against
a live account and 6131 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 515 of the 662, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 515 of the 662 here -- is served exactly as it
...
The table reaches 515 of the 662 Recipes. The other 147 ship and can be named
