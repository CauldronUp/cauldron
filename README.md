...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 485 of 628 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9124 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9124 cases, 3309 run against
a live account and 5815 not. Documentation-derived cases are worth having,
...
**The number will not reach 628.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 501 of the 628, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 501 of the 628 here -- is served exactly as it
...
The table reaches 485 of the 628 Recipes. The other 143 ship and can be named
