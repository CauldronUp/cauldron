...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 163 of 184 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 1929 cases, 58 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 1929 cases, 58 run against
a live account and 1871 not. Documentation-derived cases are worth having,
...
The table reaches 163 of the 184 Recipes. The other 21 ship and can be named
