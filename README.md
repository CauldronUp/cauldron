...
| Conformance suites (`cauldron verify`) | Working. 1106 cases, all from documentation so far |
...
Recipe: 1106 cases, none yet run against a live account. Documentation-derived
