...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 504 of 649 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9350 cases, 3346 of them checked against a live API |
...
ok    docker                 running
warn  ports                  6499 wanted by redis, held by other-project-redis-1
...
That second line is the honest one. Of every Recipe: 9350 cases, 3346 run against
a live account and 6004 not. Documentation-derived cases are worth having,
...
**The number will not reach 649.** Most providers publish nothing, and this
...
| `undeclared` | No description is recorded for this Recipe. 504 of the 649, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 504 of the 649 here -- is served exactly as it
...
The table reaches 504 of the 649 Recipes. The other 145 ship and can be named
