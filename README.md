...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 256 of 280 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 2849 cases, 534 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 2849 cases, 534 run against
...
The five hundred and thirty-four are the cases whose provider can be asked without a key. Six are
...
The table reaches 256 of the 280 Recipes. The other 24 ship and can be named
