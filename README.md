...
| Conformance suites (`cauldron verify`) | Working. 789 cases, all from documentation so far |
...
Recipe: 789 cases, none yet run against a live account. Documentation-derived
