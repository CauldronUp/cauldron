...
| Conformance suites (`cauldron verify`) | Working. 622 cases, all from documentation so far |
...
Recipe: 622 cases, none yet run against a live account. Documentation-derived
