...
| Conformance suites (`cauldron verify`) | Working. 6606 cases, 3309 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 6606 cases, 3309 run against
a live account and 3297 not. Documentation-derived cases are worth having,
