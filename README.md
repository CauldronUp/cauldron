...
| Area | State |
|---|---|
| Detection engine (Composer, npm, Go modules) | Working. 515 of 660 Recipes are reachable from a dependency |
...
| Conformance suites (`cauldron verify`) | Working. 9467 cases, 3356 of them checked against a live API |
...
That second line is the honest one. Of every Recipe: 9467 cases, 3356 run against
a live account and 6111 not. Documentation-derived cases are worth having,
...
| `undeclared` | No description is recorded for this Recipe. 515 of the 660, and falling -- see `cauldron discover` |
...
provider publishes nothing -- 515 of the 660 here -- is served exactly as it
...
The table reaches 515 of the 660 Recipes. The other 145 ship and can be named
