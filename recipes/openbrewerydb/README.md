...
**16 conformance cases, 10 checked against the live API on 2026-08-29.** The unchecked one is the paging case: it sends the two parameter names this Recipe declares, which is a claim read from the provider's own description rather than struck against it.
