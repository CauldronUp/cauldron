...
- Machine-readable description: https://amplitude.com/openapi.json, last checked 2026-09-05
  `cauldron drift amplitude` compares it against what this Recipe claims.
