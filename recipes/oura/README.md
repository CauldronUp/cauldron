...
**13 conformance cases, 10 checked against the live API on 2026-09-02.** The unchecked one is the paging case: it sends the parameter names this Recipe declares, read from the provider's own description rather than struck against it.
