...
**12 conformance cases, 8 checked against the live API on 2026-08-25.** The unchecked one is the paging case: it sends the parameter names this Recipe declares, read from the provider's own description rather than struck against it.
